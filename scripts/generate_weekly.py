...
Generates weekly ranking of repos with 90-day star growth >= 2000 and created within 36 months.
"""
...
search_queries = [
    f"created:>{WINDOW_90D_START.strftime('%Y-%m-%d')} stars:>1500",
...
<div class="wrap">
  <header class="masthead">
    <div class="kicker">Weekly GitHub Star Growth · 开源星增周榜</div>
    <h1>GitHub Star 增长周榜</h1>
    <p class="sub">统计窗口 {RUN_DATE} ｜ 筛选「近三个月 star 净增长 ≥ 2000」且创建于近 36 个月内的公开仓库。
